...
9. README 등 Markdown 문서의 설명, 주석, 작업 메모는 기본적으로 한글로 작성한다.
...
- 기본: 한국어
- 영어: 사용자가 요청한 경우만
- Markdown 문서: README, 규칙, 제안서, 작업 메모의 본문 설명과 주석은 한글로 작성한다.
- 예외: 명령어, 코드, 파일 경로, 환경 변수, API 필드명, 라이브러리명, 고유명사는 원문을 유지한다.
- 톤: 공식적이고 전문적인 문체
